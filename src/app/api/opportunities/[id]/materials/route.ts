...
// GET /api/opportunities/[id]/materials - Get all materials for an opportunity
export async function GET(
  ...
  try {
    ...
    const materials = await prisma.opportunity_materials.findMany({
      where: {
...
// POST /api/opportunities/[id]/materials - Create a new material
export async function POST(
  ...
  try {
    ...
    const newMaterial = await prisma.opportunity_materials.create({
      data: {
        opportunityId: opportunityId,
        type: type,
